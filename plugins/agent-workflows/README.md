...
- `security-review` — Adversarial security review: PII handling, secrets usage, IAM scoping, auth integrity, injection vectors.
- `convention-review` — Convention-based code review: middleware patterns, import rules, IaC patterns, frontend stack compliance.
